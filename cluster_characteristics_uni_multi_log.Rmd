...
cluster_1 
```{r}
model_1_unadjusted <- glm(cluster_kmeans_1 ~ Lymphocyte_count.0.0 + Monocyte_count.0.0 + Reti_count.0.0 + WBC_count.0.0 + RBC_count.0.0 + Hgb_conc.0.0 + Haematocrit_perc.0.0 + Platelet_count.0.0 + Basophil_count.0.0 + Eosinophil_count.0.0 + Neutrophil_count.0.0 + Immature_ret_fraction.0.0 + High_light_scatter_reti_count.0.0, train_3k, family = 'binomial')
...
cluster 2 
```{r}
model_2_unadjusted <- glm(cluster_kmeans_2 ~ Lymphocyte_count.0.0 + Monocyte_count.0.0 + Reti_count.0.0 + WBC_count.0.0 + RBC_count.0.0 + Hgb_conc.0.0 + Haematocrit_perc.0.0 + Platelet_count.0.0 + Basophil_count.0.0 + Eosinophil_count.0.0 + Neutrophil_count.0.0 + Immature_ret_fraction.0.0 + High_light_scatter_reti_count.0.0, train_3k, family = 'binomial')
